...
const connect = async () => {
  const URL = process.env.DATABASE_URL || "mongodb://localhost";
...
const getMemberById = async (req, res, next) => {
  try {
    res.member = await Member.findById(req.params.id); //if we find it we create a 'member' value on the response object - to make it accessible to the next() function
